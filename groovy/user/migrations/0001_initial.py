    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grade",
                    models.SmallIntegerField(choices=[(1, 1), (2, 2), (3, 3), (4, 4)]),
                ),
                (
                    "profile_image_url",
                ...
                (
                    "deleted_reason",
                    models.CharField(
                        blank=True, choices=[("기타", "기타")], max_length=255, null=True
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.DO_NOTHING, to="user.university"
            ),
        ),
        migrations.AddField(
            model_name="user",
